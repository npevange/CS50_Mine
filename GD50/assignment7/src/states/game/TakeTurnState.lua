            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        -- this one is used to calculate actual level up values.
                        local testHP, testATK, testDFN, testSPD = self.playerPokemon:levelUp()

                        gStateStack:push(BattleMessageState('Congratulations! Level Up!',
                        function()
                            --TODO: Pop the level up menu here !
                            gStateStack:push(MenuState(self.battleState.player.party, testHP, testATK, testDFN, testSPD,
                        function()
                            self:fadeOutWhite()
                        end))
                        end))
